...
typedef int (__cdecl *Team_TouchEnemyFlag_ptr)( gentity_t *ent, gentity_t *other, int team );
typedef int (__cdecl *Team_TouchOurFlag_ptr)( gentity_t *ent, gentity_t *other, int team );
...
extern Team_TouchEnemyFlag_ptr Team_TouchEnemyFlag;
extern Team_TouchOurFlag_ptr Team_TouchOurFlag;
