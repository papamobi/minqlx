...
typedef void (__cdecl *player_die_ptr)( gentity_t *self, gentity_t *inflictor, gentity_t *attacker, int damage, int meansOfDeath );
...
typedef int (__cdecl *Pickup_Team_ptr)( gentity_t *ent, gentity_t *other );
...
extern Pickup_Team_ptr Pickup_Team;
