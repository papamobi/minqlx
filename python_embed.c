...
static PyObject* PyMinqlx_InitModule(void) {
    ...
    PyModule_AddIntMacro(module, MODELINDEX_ARMORCOMBAT);
    PyModule_AddIntMacro(module, MODELINDEX_ARMORBODY);
    PyModule_AddIntMacro(module, MODELINDEX_ARMORJACKET);
    PyModule_AddIntMacro(module, MODELINDEX_HEALTHSMALL);
    PyModule_AddIntMacro(module, MODELINDEX_HEALTH);
    PyModule_AddIntMacro(module, MODELINDEX_HEALTHLARGE);
    ...
    PyModule_AddIntMacro(module, MODELINDEX_QUAD);
    PyModule_AddIntMacro(module, MODELINDEX_ENVIRONMENTSUIT);
    PyModule_AddIntMacro(module, MODELINDEX_HASTE);
    PyModule_AddIntMacro(module, MODELINDEX_INVISIBILITY);
    PyModule_AddIntMacro(module, MODELINDEX_REGEN);
    ...
    PyModule_AddIntMacro(module, MODELINDEX_DOUBLER);
    PyModule_AddIntMacro(module, MODELINDEX_AMMOREGEN);
    PyModule_AddIntMacro(module, MODELINDEX_NEUTRALFLAG);
    PyModule_AddIntMacro(module, MODELINDEX_REDCUBE);
    PyModule_AddIntMacro(module, MODELINDEX_BLUECUBE);
    ...
    PyModule_AddIntMacro(module, MODELINDEX_HMG);
    PyModule_AddIntMacro(module, MODELINDEX_HEAVYBULLETS);
    PyModule_AddIntMacro(module, MODELINDEX_AMMOPACK);
    PyModule_AddIntMacro(module, MODELINDEX_SILVERKEY);
    PyModule_AddIntMacro(module, MODELINDEX_GOLDKEY);
    PyModule_AddIntMacro(module, MODELINDEX_MASTERKEY);
